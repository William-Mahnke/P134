...
```{r}
py$install(c("pandas", "numpy", "scikit-learn",
...
1.  How many rows are in `starwars`? How many columns? Six rows and 14 columns

2.  What does the `vehicles` variable in the `starwars` data set describe? How do you know? Represents a list of vehicles owned by the character.
